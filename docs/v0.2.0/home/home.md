...
![Verdocs Logo](assets/verdocs-logo-with-name.jpeg)
...
Ready to jump in? Go to the [Quick Start Guide](@/quick-start/quick-start.md) to initialize your first project!
{/TIP}

### Key Features

1.  **Markdown Native**: Full support for standard and extended Markdown syntax.
2.  **Live Development Server**: Preview changes in real-time with an integrated development server.
3.  **Local Search Index**: High-speed search across all documentation versions via a client-side index.
4.  **Automated Navigation**: Dynamic sidebar and navigation generation derived from your directory structure.
5.  **Fully Responsive**: Modern, adaptive layout that looks great on mobile, tablet, and desktop screens.
